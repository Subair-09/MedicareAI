...
Do not wrap with markdown backticks if possible, return raw JSON string.`;
  ...
  private processParsedResponse(
    ...
    // ENFORCE MANDATORY IN-CHAT FORM FOR ALL BOOKINGS:
    // Under hospital rules, appointments can NEVER be booked or confirmed via conversational chat text.
    ...
    const isBookingAttempt =
      ...
      /(\bbook\b|\bschedule\b|\breserve\b|\bappointment\b)/i.test(userMessage);
